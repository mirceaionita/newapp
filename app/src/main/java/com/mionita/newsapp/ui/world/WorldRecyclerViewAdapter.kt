package com.mionita.newsapp.ui.world
...
class WorldRecyclerViewAdapter(
    private val mValues: List<WorldNewsContent.NewsItem>,
    private val mListener: WorldNewsFragment.OnListFragmentInteractionListener?
) : RecyclerView.Adapter<WorldRecyclerViewAdapter.ViewHolder>() {

    private val mOnClickListener: View.OnClickListener

    init {
        mOnClickListener = View.OnClickListener { v ->
            val item = v.tag as WorldNewsContent.NewsItem
