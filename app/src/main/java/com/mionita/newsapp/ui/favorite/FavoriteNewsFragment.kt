 ...
 * [FavoriteNewsFragment.OnListFragmentInteractionListener] interface.
 */
class FavoriteNewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            FavoriteNewsContent.createNewsList(newsService.loadFavoriteNews())
        }
    }
    ...
    interface OnListFragmentInteractionListener {
        fun onListFragmentInteraction(item: FavoriteNewsContent.NewsItem?)
    }
