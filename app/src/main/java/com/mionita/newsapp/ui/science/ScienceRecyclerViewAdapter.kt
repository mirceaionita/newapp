...
class ScienceRecyclerViewAdapter(
    private val mValues: List<ScienceNewsContent.NewsItem>,
    private val mListener: ScienceNewsFragment.OnListFragmentInteractionListener?
) : RecyclerView.Adapter<ScienceRecyclerViewAdapter.ViewHolder>() {

    private val mOnClickListener: View.OnClickListener

    init {
        mOnClickListener = View.OnClickListener { v ->
            val item = v.tag as ScienceNewsContent.NewsItem
